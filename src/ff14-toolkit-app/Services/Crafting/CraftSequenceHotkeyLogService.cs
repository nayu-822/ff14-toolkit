...
public sealed class CraftSequenceHotkeyLogService
{
    private readonly string logFilePath;
    private readonly Lock syncRoot = new();

    public CraftSequenceHotkeyLogService(IOptions<CacheOptions> cacheOptions)
    {
        ...
        logFilePath = Path.Combine(rootPath, "Logs", "craft-sequence-hotkeys.log");
    }
    ...
    private void Write(string level, string message)
    {
        ...
        {
            // Logging must not interrupt the app flow.
        }
    }
}
